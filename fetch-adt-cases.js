...
/**
 * Fetch ADT Alerts test cases from Qase (IDs 266-281)
 */
...
const TEST_CASE_IDS = [266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276, 277, 278, 279, 280, 281];
...
async function main() {
  console.log('\n🔄 Fetching ADT Alerts test cases from Qase...\n');
  ...
  // Save to JSON file
  fs.writeFileSync(
    'adt-alerts-cases.json',
    JSON.stringify(testCases, null, 2)
  );

  console.log(`\n✅ Fetched ${testCases.length}/${TEST_CASE_IDS.length} test cases`);
  console.log(`📄 Saved to adt-alerts-cases.json\n`);
}
