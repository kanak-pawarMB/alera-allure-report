...
const caseIds = [362, 363, 364, 366, 367, 368, 369, 370, 371, 372, 373, 374, 376, 377, 378];
...
async function main() {
  ...
  fs.writeFileSync('care-gaps-cases.json', JSON.stringify(cases, null, 2));
  console.log(`\n✓ Fetched ${cases.length}/${caseIds.length} cases`);
  console.log('✓ Saved to care-gaps-cases.json');
}
