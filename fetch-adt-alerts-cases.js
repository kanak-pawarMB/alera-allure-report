...
const CASE_IDS = [449, 452, 453, 454, 455, 456, 457, 458, 459, 460, 461, 463, 464, 466];
...
async function fetchCases() {
  console.log(`Fetching ${CASE_IDS.length} ADT Alerts test cases from Qase...`);
  const cases = [];
  ...
  fs.writeFileSync('adt-alerts-cases.json', JSON.stringify(cases, null, 2));
  console.log(`\n✓ Fetched ${cases.length}/${CASE_IDS.length} cases → adt-alerts-cases.json`);
}
