...
> **Note:** The `chromium`, `firefox`, and `safari` projects exclude smoke tests to avoid duplication. Always use `--project=smoke` when running smoke tests, even in headed mode.
